...
== Example usage
  ...
  client.merchant  # => <Grapi::Merchant ...>

  # The client allows you to look up most resources by their id
  client.subscription(5)       # => <Grapi::Subscription ...>
  client.pre_authorization(5)  # => <Grapi::PreAuthorization ...>
  client.bill(5)               # => <Grapi::Bill ...>
  client.payment(5)            # => <Grapi::Payment ...>

  # Retrieve referenced resources directly from resource objects
  subscription = client.subscription(5)
  subscription.merchant  # => <Grapi::Merchant ...>
